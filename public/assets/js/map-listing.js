var markers = [];
	    ...
	    var mattone_restaurant = '<div class="places-item" id="mattone_restaurant">'+
            ...
            '<span class="places-item__category">رستوران</span>' +
            '<h3>رستوران گردون</h3>' +
            '<div class="places-item__meta">' +
            '<div class="places-item__reviews">' +
            '<span class="places-item__number">' +
            '4.8<i class="la la-star"></i>' +
            '<span class="places-item__count">(9 نظر)</span>' +
            '</span>'+
            '</div>'+
            '<div class="places-item__currency">ت</div>' +
            '</div>'+
            '</div>'+
            '</div>';
        ...
        var retro_fitness = '<div class="places-item" id="retro_fitness">'+
            ...
            '<div class="places-item__info">'+
            '<span class="places-item__category">باشگاه بدنسازی</span>' +
            '<h3>باشگاه بدنسازی مروارید</h3>' +
            '<div class="places-item__meta">' +
            '<div class="places-item__reviews">' +
            '<span class="places-item__number">' +
            '4.8<i class="la la-star"></i>' +
        ...
        var body_spa = '<div class="places-item" id="body_spa">'+
            ...
            '<div class="places-item__info">'+
            '<span class="places-item__category">سالن زیبایی و ماساژ</span>' +
            '<h3>سالن زیبایی فرشته</h3>' +
            '<div class="places-item__meta">' +
            '<div class="places-item__reviews">' +
            '<span class="places-item__number">' +
            '4.8<i class="la la-star"></i>' +
        ...
        var antoinette = '<div class="places-item" id="antoinette">'+
            ...
            '<div class="places-item__info">'+
            '<span class="places-item__category">پاساژ لباس</span>' +
            '<h3>پاساژ لباس تیراژه</h3>' +
            '<div class="places-item__meta">' +
            '<div class="places-item__reviews">' +
            '<span class="places-item__number">' +
            '4.8<i class="la la-star"></i>' +
        ...
        var vago_restaurant = '<div class="places-item" id="vago_restaurant">'+
            ...
            '<div class="places-item__info">'+
            '<span class="places-item__category">سینما و تئاتر</span>' +
            '<h3>رستوران شیلا</h3>' +
            '<div class="places-item__meta">' +
            '<div class="places-item__reviews">' +
            '<span class="places-item__number">' +
        ...
        var kathay_cinema = '<div class="places-item" id="kathay_cinema">'+
            ...
            '<div class="places-item__info">'+
            '<span class="places-item__category">سینما</span>' +
            '<h3>سینما بهمن</h3>' +
            '<div class="places-item__meta">' +
            '<div class="places-item__reviews">' +
            '<span class="places-item__number">' +
        ...
        var jardin_club = '<div class="places-item" id="jardin_club">'+
            ...
            '<div class="places-item__info">'+
            '<span class="places-item__category">کلاپ</span>' +
            '<h3>کلاب کاوالی دبی</h3>' +
            '<div class="places-item__meta">' +
            '<div class="places-item__reviews">' +
            '<span class="places-item__number">' +
            '4.8<i class="la la-star"></i>' +
        ...
        var vivi = '<div class="places-item" id="vivi">'+
            ...
            '<div class="places-item__info">'+
            '<span class="places-item__category">سالن ماساژ</span>' +
            '<h3>سالن ماساژ و آبگرم</h3>' +
            '<div class="places-item__meta">' +
            '<div class="places-item__reviews">' +
            '<span class="places-item__number">' +
            '4.8<i class="la la-star"></i>' +
